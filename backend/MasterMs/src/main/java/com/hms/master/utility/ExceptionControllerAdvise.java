package com.hms.master.utility;
...
public class ExceptionControllerAdvise {
    ...
    public ResponseEntity<ErrorInfo> hmsExceptionHandler(HMSException e){//Excepton handling for user >> Deligation >> e.getMessage() >> environment >> application.properties
    ...
    public ResponseEntity<ErrorInfo> hmsValidationExceptionHandler(Exception e){
        String errorMsg;
