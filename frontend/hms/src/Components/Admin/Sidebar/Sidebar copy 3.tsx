import {
  ...
  const SidebarLinkItem = ({ link }: { link: SidebarLink }) => {
    ...
    const baseClass = "flex items-center w-full h-12 font-medium rounded-lg transition-colors";
  ...
  const Sidebar = () => {
    ...
    return (
      <div className="flex">
        <div className="w-64" />
        <div className="w-64 fixed h-screen overflow-y-auto bg-[#202A44] flex flex-col gap-7 items-center">
          {/* Logo/Header */}
          <div className="fixed z-[500] bg-[#202A44] py-3 text-white flex gap-1 items-center rounded-xl">
